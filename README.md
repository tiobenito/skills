...
- **idea-eval** → first run interviews you for your constraints, goals, and team, then saves them to `references/profile.md` (drives the scoring)
- **project-roadmap** → just point it at a project folder; pick a theme (`cream`/`forest`/`midnight`) or edit the `[data-theme]` blocks to match your brand
